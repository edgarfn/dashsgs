...
| **7 Dashboard MVP** ← atual (3 sem) | Valor visível | Home executiva, Vendas (diário/comparativos), Metas, Estoque-Ruptura/Vencimentos, exports CSV, estados vazios/erro, mobile da home | KPIs batem com dataset canônico (snapshot); p95<300 ms; LCP<2,5 s | Escopo de UI crescer — cortar por valor doc 15 |
