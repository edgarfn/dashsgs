...
| **8 Alertas & Financeiro** ← atual (3 sem) | Retenção do produto | Motor de regras + dedupe + e-mail; regras padrão doc 15 §8; telas Financeiro (aging, despesas, cartões) e Compras; sync respectivo | Alertas E2E ≤5 min; aging bate com ERP amostrado | Regra barulhenta → tuning com design partner |
