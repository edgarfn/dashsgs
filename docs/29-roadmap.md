...
| **9 Security Hardening** ← atual (2 sem) | Pronto p/ terceiros | Pentest externo + correções; headers/CSP final; break-glass; retenções/purge automatizados; DPA/política privacidade; checklist ASVS L2 crítico | Pentest sem High aberto; checklist doc 32 ≥ itens bloqueantes | Findings profundos → buffer |
