...
| **10 Observability & SRE** ← atual (1–2 sem, paralelo 8–9) | Operável | Painéis Grafana, alertas operacionais, SLO board, backups WAL-G + restore test semanal automatizado, runbooks validados | Game-day parcial: restore + deploy + rollback executados | — |
